<template>
  <div class="fillcontain">
    <div class="table_container">
      ...
      <el-dialog v-model="dialogFormVisible" title="修改食品信息">
        <el-form :model="selectTable">
          ...
          <el-form-item label="食品介绍" label-width="100px">
            <el-input v-model="selectTable.description" />
          </el-form-item>
        ...
        <el-row style="overflow: auto; text-align: center;">
          ...
          <el-button type="primary" style="margin-bottom: 10px;" @click="specsFormVisible = true">添加规格</el-button>
        </el-row>
      ...
      <el-dialog v-model="specsFormVisible" title="添加规格">
        <el-form :rules="specsFormrules" :model="specsForm">
          <el-form-item label="规格" label-width="100px" prop="specs">
            <el-input v-model="specsForm.specs" auto-complete="off" />
          </el-form-item>
          <el-form-item label="包装费" label-width="100px">
            <el-input-number v-model="specsForm.packing_fee" :min="0" :max="100" />
          </el-form-item>
