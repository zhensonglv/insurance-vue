<template>
  <div class="app-container">
    <el-card>
      <div>
        <el-input v-model="listQuery.mediGroupNo" style="width: 200px;" placeholder="请输入医疗集团号查询" />
        <el-input v-model="listQuery.mediGroupName" style="width: 200px;" placeholder="请输入集团名称查询" />
      ...
      <el-table v-loading="listLoading" :data="list" element-loading-text="Loading" border fit highlight-current-row>
        ...
        <el-table-column align="center" label="医疗集团号" width="150">
          <template slot-scope="scope">
            {{ scope.row.mediGroupNo }}
          </template>
        </el-table-column>

        <el-table-column align="center" label="集团名称" width="150">
          <template slot-scope="scope">
            {{ scope.row.mediGroupName }}
          </template>
        </el-table-column>
