<template>
  <div class="app-container">
    <el-card>
      <div>
        <el-input v-model="listQuery.teamNo" style="width: 200px;" placeholder="请输入团体号查询" />
        <el-input v-model="listQuery.plyPartNo " style="width: 200px;" placeholder="请输入分单号查询" />
        <el-input v-model="listQuery.insuredId" style="width: 200px;" placeholder="请输入被保人ID查询" />
        <el-input v-model="listQuery.plyNo" style="width: 200px;" placeholder="请输入保单号查询" />
        <el-input v-model="listQuery.teamNme" style="width: 200px;" placeholder="请输入团体名称查询" />
