<template>
  <el-dialog :title="dialogTitle" :before-close="handleClose" :visible.sync="dialogVisible" width="55%">
    <el-form ref="form" :inline="true" :rules="rules" :model="form" status-icon label-position="right" label-width="80px">
      <el-form-item label="保险公司代码" prop="insuCompanyCde" label-width="120px">
        <el-input v-model="form.insuCompanyCde" placeholder="请输入保险公司代码" />
      </el-form-item>
...
export default {
  ...
  data() {
    return {
      ...
      rules: {
        insuCompanyCde: [{ required: true, trigger: 'blur', message: '请输入保险公司代码' }],
        insuCompanyNme: [{ required: true, trigger: 'blur', message: '请输入保险公司名称' }],
        insuBranckCompanyNme: [{ required: true, trigger: 'blur', message: '请输入保险分公司名称' }]
      }
    }
  },
  watch: {
