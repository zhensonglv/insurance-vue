  ...
  <div class="app-container">
    <el-card>
      <div>
        ...
        <el-input v-model="listQuery.crtCde" style="width: 200px;" placeholder="请输入创建人查询" />
      ...
      <el-table v-loading="listLoading" :data="list" element-loading-text="Loading" border fit highlight-current-row>
        ...
        <el-table-column align="center" label="保险公司代码" width="150">
          <template slot-scope="scope">
        ...
        <el-table-column align="center" label="保险分公司名称" width="150">
          <template slot-scope="scope">
...
export default {
  ...
  methods: {
    ...
    resetData() {
      this.listQuery.insuCompanyNme = null
      this.listQuery.insuBranckCompanyNme = null
      this.listQuery.crtCde = null
    },
    fetchTypeData() {
      // 获取codeList
      var parantData = ['Language']
    ...
    handleSave() {
      this.form = { id: null, insuCompanyNme: this.listQuery.insuCompanyNme }
