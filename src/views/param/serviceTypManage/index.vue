  ...
  <div class="app-container">
    <el-card>
      <div>
        ...
        <el-input v-model="listQuery.servCategory" style="width: 200px;" placeholder="请输入类别查询" />
      ...
      <el-table v-loading="listLoading" :data="list" element-loading-text="Loading" border fit highlight-current-row>
        ...
        <el-table-column align="center" label="服务类型英文描述" width="150">
          <template slot-scope="scope">
            {{ scope.row.servTypEngdesc }}
          </template>
        </el-table-column>
        ...
        <el-table-column align="center" label="大项名称" width="150">
          <template slot-scope="scope">
