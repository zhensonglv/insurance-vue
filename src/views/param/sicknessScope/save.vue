  ...
  <el-dialog :title="dialogTitle" :before-close="handleClose" :visible.sync="dialogVisible" width="55%">
    <el-form ref="form" :inline="true" :rules="rules" :model="form" status-icon label-position="right" label-width="80px">
      ...
      <el-form-item label="代码类型" prop="cdeType" label-width="120px">
        <el-input v-model="form.cdeType" placeholder="请输入代码类型" />
      </el-form-item>
      <el-form-item label="起始代码" prop="sickBgnCde" label-width="120px">
        <el-input v-model="form.sickBgnCde" placeholder="请输入起始代码" />
      </el-form-item>
      <el-form-item label="终止代码" prop="sickEndCde" label-width="120px">
        <el-input v-model="form.sickEndCde" placeholder="请输入终止代码" />
      </el-form-item>
      <el-form-item label="起始代码描述" prop="sickBgnDesc" label-width="120px">
        <el-input v-model="form.sickBgnDesc" placeholder="请输入起始代码描述" />
      </el-form-item>
      <el-form-item label="终止代码描述" prop="sickEndDesc" label-width="120px">
